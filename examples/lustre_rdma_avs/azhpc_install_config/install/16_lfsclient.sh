...
pssh -p 50 -t 0 -i -h hostlists/tags/$tag "cd azhpc_install_config; sudo scripts/lfsclient.sh '$(head -n1 hostlists/tags/lfsmaster)' '/lustre'" >> install/16_lfsclient.log 2>&1
