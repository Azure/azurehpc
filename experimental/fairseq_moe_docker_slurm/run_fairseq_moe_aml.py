...
#-------------------------------------------------------------------------------
fairseq_env = Environment.get(ws, name="YOUR_ENVIRONMENT_NAME", version="YOUR_ENVIRONMENT_VERSION")
...
fairseq_src = ScriptRunConfig(
    source_directory='/path/to/your/code/files',
    #script='train.py',
    #arguments=run_args,
    command=launch_cmd,
...
run = Experiment(ws, 'YOUR_EXPERIMENT_NAME').submit(fairseq_src)
