...
| **os_storage_sku**         | OS Storage SKU. `Premium_LRS`, `StandardSSD_LRS`, `Standard_LRS` or `UltraSSD_LRS` (which needs availability_zones to be defined)          |   no     |Premium_LRS|
...
| **storage_sku**            | Data Disk Storage SKU. `Premium_LRS`, `StandardSSD_LRS` or `Standard_LRS`, `UltraSSD_LRS`   |   no     |Premium_LRS|
