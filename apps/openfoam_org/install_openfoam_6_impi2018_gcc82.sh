...
sed -i 's/WM_MPLIB=SYSTEMOPENMPI/WM_MPLIB=INTELMPI/g' OpenFOAM-6/etc/bashrc

cat <<EOF >setenv.sh
MY_DIR="\$( cd "\$( dirname "\${BASH_SOURCE[0]}" )" && pwd )"
. /opt/intel/impi/2018.4.274/bin64/mpivars.sh
